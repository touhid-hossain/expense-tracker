  ...
  return (
    <Form {...form}>
      <Avatar className="h-20 w-20">
        <AvatarImage
          className="bg-cover"
          src={imageFile ? URL.createObjectURL(imageFile) : `http://localhost:5000/${user?.image_url}`}
        />
            ...
            <FormItem>
              ...
              <FormControl>
                <div className="relative">
                  ...
                  <Input className="pl-7" type="password" placeholder="Enter your current password" {...field} />
                </div>
              </FormControl>
              <FormMessage />
            </FormItem>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <div className="relative">
                  <Lock className="absolute left-2 top-[11px] h-4 w-4 text-muted-foreground" />
                  <Input className="pl-7" type="password" placeholder="Enter your new password" {...field} />
                </div>
              </FormControl>
              <FormMessage />
            </FormItem>
        ...
        />
        {
          isEditing && (
            <div className="flex flex-row gap-2">
              <Button className="w-[140px] col-span-2" type="submit">Update</Button>
              <Button
